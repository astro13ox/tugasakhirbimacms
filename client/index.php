...
<body>
	<div class="error_page">
		...
		<div class="error-top">
			<h2 class="inner-tittle page">Klien CMS</h2>
			<div class="login">
				
				<div class="buttons login">
					<h3 class="inner-tittle t-inner" style="color: lightblue">Login</h3>
				</div>
				<form id="login" method="post" name="login"> 
					...
					<div class="submit"><input type="submit" onclick="myFunction()" value="Masuk" name="login" ></div>
					<div class="clearfix"></div>

					<div class="new">
						<p><a href="forgot-password.php">Lupa Kata Sandi</a></p><br />
